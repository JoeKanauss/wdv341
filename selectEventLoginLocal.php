...
if($result) 
{
	...
	if($result->rowCount() > 0)
	{
		...
		foreach ($result as $row) 
		{
			...
			$display .= "</td>";
			$display .= "<td>";
			$display .="<a href='deleteEventLocal.php?id=$row[event_id]'>Delete</a>";
			$display .= "</td>";
			$display .= "<td>";
			$display .="<a href='updateEventFormLocal.php?id=$row[event_id]'>Update</a>";
			$display .= "</td></tr>";
	}
...
<p><a href= "eventsFormLocal.php">Create a New Event</a></p>
<p><a href="logoutLocal.php">Logout</a></p>
</div>
...
<h2>Please Log In to See the Events</h2>
<form method="post" name="loginForm" action="selectEventloginLocal.php">
