...
//          CHANGE THE FOLLOWING INFORMATION TO SEND EMAIL FOR YOU //  
	...
	$toEmail = "penpaperjoe@gmail.com";		//CHANGE within the quotes. Place email address where you wish to send the form data. 
										//Use your DMACC email address for testing. 
										//Example: $toEmail = "jhgullion@dmacc.edu";		
	
	$subject = "WDV341 Form Emailer";	//CHANGE within the quotes. Place your own message.  For the assignment use "WDV101 Email Example" 

	$fromEmail = "web@joekanauss.info";		//CHANGE within the quotes.  Use your DMACC email address for testing OR
