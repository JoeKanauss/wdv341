...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inHotdog = $_POST["hotdogs"];
	$inConnectIA1 = $_POST["bornIA"];
	$inConnectIA2 = $_POST["liveIA"];
	$inFromState = $_POST["fromState"];
...
<p>Relationship with Hotdogs: <?php echo $inHotdog; ?></p>
<p>Connection with Iowa: <?php echo $inConnectIA1," ",$inConnectIA2?></p>
<p>Where Are You From: <?php echo $inFromState; ?></p>
