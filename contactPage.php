...
<div id="logins">
<p><a href="homepageLocal.php">Home</a></p>
<p><a class="selected" href="loginLocal.php">Log In</a></p>
<p><a href="signUpPageLocal.php">Sign Up</a></p>
<p><a href="bookshelfLocal.php">See the Bookshelf</a></p>
<p><a href="profilePageLocal.php">Go to Profile</a></p>
</div>
...
if(isset($_POST["contactSubmit"]))
{
	//display message
?>
<h2 class="contactMsg"><?php echo$sendAdminFail."<br>".$sendAdminSuccess."<br>".$sendContactMessage."<br><a href=''>[Go to the Homepage]</a>"?></h2>
<?php
}
else
{
